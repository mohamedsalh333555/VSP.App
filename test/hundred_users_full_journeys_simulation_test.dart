...
void main() {
  group('🎮 VSP 100 Concurrent Virtual Users Live Simulation (20 Owners + 80 Players)', () {
    ...
    test('E2E Full Journeys: 20 Owners Setup Stadiums & Tournaments -> 80 Players Book & Compete', () async {
      ...
      // -------------------------------------------------------------------
      print('\n🏟️ [PHASE 2] 20 Owners listing 30 Diverse Stadiums...');
      ...
      // -------------------------------------------------------------------
      print('\n🛡️ [PHASE 4] 80 Players forming 16 Teams (Respecting 12-member & 3-team limits)...');
      ...
      print('   🛡️ SUCCESS: 1 Booking confirmed, 29 race-condition double-bookings blocked!');
      ...
      print('🏟️ Total Stadiums Configured: ${activeStadiums.length} ($cashCount Cash 💵, $depositCount Deposit 🔒)');
      print('🏆 Total Tournaments Created: ${activeTournaments.length}');
      print('🛡️ Total Teams Established: ${activeTeams.length}');
