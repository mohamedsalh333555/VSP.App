...
void main() {
  group('VSP Authentication, Roles, Block Gating, and Password Recovery Tests', () {
    ...
    test('Step 2: Owner Onboarding Gates (Stadium & Docs)', () {
      print('🏟️ [TEST] Simulating a newly registered Owner (No Stadium yet)...');
      ...
      print('🏟️ [TEST] Simulating Owner with Stadium but unverified documents...');
      ...
      print('🏟️ [TEST] Simulating Owner with Stadium and pending documents (Sandbox Bypass)...');
