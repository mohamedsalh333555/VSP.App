...
class _InformationTab extends StatelessWidget {
 ...
 Text(rawDesc, style: Theme.of(context).textTheme.bodySmall?.copyWith(color: VSPColors.textSecondary, height: 1.6)),
          ...
          const SizedBox(height: VSPSpacing.md),
          // Merged Minimalist & Compact Amenities & Add-ons Card
          Container(
            width: double.infinity,
            ...
            child: Column(
              ...
              children: [
                ...
                // 2. Clean 2-Column Minimalist Amenities Grid
                _FacilitiesGrid(stadium: stadium),

                // 3. Compact Integrated Ball Add-on Row (100% VSP Neon Theme)
                    ...
                    child: Row(
                      children: [
                        ...
                        Container(
                          ...
                          child: Text(
                            isArabic
                                ? '+${stadium.ballPrice.toInt()} ج.م'
                                : '+${stadium.ballPrice.toInt()} EGP',
                            style: const TextStyle(
                              color: VSPColors.accent,
                              fontWeight: FontWeight.w900,
                              fontSize: 11.5,
