          ...
          children: [
            ...
            if (isOwner) ...[
              ...
              _buildSectionCard(
                ...
                content: isArabic
                    ? '• يُسمح بإلغاء حجز الملاعب حتى قبل موعد بدء المباراة بـ 6 ساعات (6 Hours) للحصول على استرداد مالي كامل (100%).\n• للبطولات الرياضية: يُسمح بالإلغاء واسترداد رسوم الاشتراك بالكامل قبل انطلاق البطولة بيومين (48 ساعة) وقبل إجراء القرعة الرسمية.\n• استثناء مهلة الـ 20 دقيقة الأولى: في حال إلغاء الحجز خلال أول 20 دقيقة من إتمامه وسداده، يُسترد المبلغ مخصوماً منه المصاريف الإدارية والتشغيلية غير المستردة (رسوم بوابة الدفع الإلكتروني وعمولة المنصة).\n• تتم معالجة ومراجعة طلبات الاسترداد المالي من قِبل فريق VSP وبوابة الدفع خلال 3-7 أيام عمل عبر وسيلة الدفع الأصلية.\n• الإلغاء بعد انقضاء المهل المحددة أو عدم الحضور (No-Show) لا يمنح الحق في استرداد العربون أو المبالغ المدفوعة.'
                    : '• Free cancellation is available up to 6 hours before kickoff for pitch bookings for a full 100% refund.\n• Tournaments: Full refund is available when withdrawing at least 2 days (48 hours) prior to kickoff and before the official draw.\n• 20-Minute Grace Window: Cancellations within the first 20 minutes of booking are refunded minus non-refundable administrative and payment gateway processing fees.\n• Refund requests are processed via Paymob and bank clearing cycles within 3-7 business days back to the original payment method.\n• Late cancellations (within 6 hours for bookings / 2 days for tournaments) or no-shows forfeit deposit/fee refunds.',
              ),
