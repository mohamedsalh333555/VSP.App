        ...
        child: Column(
          ...
          children: [
            ...
            _buildSectionCard(
              ...
              content: 'تُحسب رسوم خدمة المنصة والتشغيل (3%) بوضوح عند الدفع الإلكتروني عبر بوابة Paymob، وهي رسوم تغطي تكاليف التشغيل والخدمات التقنية وتضمن تأكيد الحجز فورياً.',
            ),
