      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            // 6. Head to Head History (المواجهات المباشرة)
            ...
            Builder(
              builder: (context) {
                ...
                final isCaptain = currentUid != null && (currentUid == team.captainId || team.memberUids.isNotEmpty && team.memberUids.first == currentUid);

                if (isCaptain) {
                  return OutlinedButton.icon(
                    onPressed: _isGeneratingCode ? null : _generateMatchupInviteCode,
                    icon: _isGeneratingCode
                        ? const SizedBox(width: 18, height: 18, child: CircularProgressIndicator(strokeWidth: 2, color: VSPColors.accent))
    ...
    return Column(
      ...
      children: [
        ...
        ListView.separated(
          ...
          itemCount: _headToHeadRecords.length,
          separatorBuilder: (_, __) => const SizedBox(height: 8),
          itemBuilder: (context, index) {
            final rec = _headToHeadRecords[index];
              ...
              child: Row(
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: teamWins > opponentWins ? VSPColors.success.withValues(alpha: 0.15) : VSPColors.surfaceAlt,
