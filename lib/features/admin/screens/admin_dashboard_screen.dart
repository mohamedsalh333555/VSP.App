...
class _AdminDashboardScreenState extends State<AdminDashboardScreen> with SingleTickerProviderStateMixin {
 ...
 Tab(text: isArabic ? 'نزاعات المباريات ' : 'Disputed Matches '),
 ...
 // ===========================================================================
 // 3⃣ TAB 3: Disputed Matches Resolution (نزاعات المباريات)
 // ===========================================================================
 ...
 child: Text(isArabic ? 'نزاع قائم ' : 'Disputed ', style: const TextStyle(color: VSPColors.error, fontSize: 10, fontWeight: FontWeight.bold)),
 ),
 ],
 ),
 const SizedBox(height: 12),
 ...
 // ===========================================================================
 // 3⃣ TAB 3: Payout Settlements (التسويات المالية للمالكين)
 // ===========================================================================
 ...
 // ===========================================================================
 // 4⃣ TAB 4: Reports & Moderation (البلاغات والحظر)
 // ===========================================================================
 ...
 // ===========================================================================
 // Administrative Actions & Helpers
 // ===========================================================================
 ...
 try {
 // BUG FIX: Removed the first update call that used 'status: blocked'
