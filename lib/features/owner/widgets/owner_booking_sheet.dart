...
''';
 ...
 Text(
 isArabic
 ? ' الحد الأقصى المتاح حتى الموعد القادم/الإغلاق: ${_formatDurationLabel(maxMins, isArabic)}'
 : ' Max available until next booking/closing: ${_formatDurationLabel(maxMins, isArabic)}',
