          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text(
                  'VSP cannot connect to its backend.',
...
void main() async {
  ...
  // Supabase is the primary backend and must be initialized successfully
  // before the application is allowed to present authenticated/business UI.
  try {
  ...
  // Firebase is auxiliary only (FCM, Analytics, Crashlytics). Failure must not
  // replace or bypass the Supabase source of truth.
  try {
