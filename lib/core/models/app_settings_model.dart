class AppSettings {
  ...
  const AppSettings({
    this.supportPhone = '01000000000',
    this.whatsappNumber = '+201000000000',
  ...
  factory AppSettings.fromMap(Map<String, dynamic>? data) {
    ...
    return AppSettings(
      supportPhone: data['support_phone'] ?? data['supportPhone'] ?? '01000000000',
      whatsappNumber: data['whatsapp_number'] ?? data['whatsappNumber'] ?? '+201000000000',
