...
class LocationService {
 ...
 onTimeout: () {
 VSPLogger.w(" SafeDevice jailbreak check timed out. Defaulting to safe state.");
 return false;
 },
 );
 ...
 const Duration(seconds: 2),
 onTimeout: () {
 VSPLogger.w(" SafeDevice mock location check timed out. Defaulting to safe state.");
 return false;
 },
 );
