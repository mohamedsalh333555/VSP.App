    ...
    final cropped = await ImageCropper().cropImage(
      ...
      uiSettings: [
        AndroidUiSettings(
          ...
          toolbarColor: VSPColors.surfaceAlt,
          toolbarWidgetColor: VSPColors.accent, // Bright VSP Accent Neon Green for checkmark & back icons
          activeControlsWidgetColor: VSPColors.accent, // Bright accent green for crop handles & sliders
          backgroundColor: VSPColors.background,
          dimmedLayerColor: Colors.black87,
          cropFrameColor: VSPColors.accent,
