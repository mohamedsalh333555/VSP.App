...
class AppConfig {
  ...
  static String get paymobApiKey => AppEnv.paymobApiKey;
  static String get paymobPublicKey => AppEnv.paymobPublicKey;
  static String get paymobSecretKey => AppEnv.paymobSecretKey;
  static String get paymobHmac => AppEnv.paymobHmac;
  static String get paymobWebhookSecret => AppEnv.paymobHmac;
