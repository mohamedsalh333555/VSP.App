...
-- ⚠️ Drop previous 20-parameter version of create_booking_atomic to prevent RPC overloading ambiguity.
-- The canonical, hardened version with idempotency support is declared below in Section 5.
